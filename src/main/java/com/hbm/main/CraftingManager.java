...
public class CraftingManager {
	...
	public static void AddCraftingRec() {
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CAPACITOR), new Object[] { "I", "N", "W", 'I', ModItems.plate_polymer, 'N', NB.nugget(), 'W', TIN.wireFine() });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CAPACITOR, 2), new Object[] { "IAI", "W W", 'I', ModItems.plate_polymer, 'A', AL.dust(), 'W', TIN.wireFine() });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CAPACITOR_TANTALIUM), new Object[] { "I", "N", "W", 'I', ModItems.plate_polymer, 'N', TA.nugget(), 'W', TIN.wireFine() });
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_tin, 1), new Object[] { "###", "###", "###", '#', TIN.wireFine() });
		...
		addRecipeAuto(new ItemStack(ModItems.coil_tin, 1), new Object[] { "WWW", "WIW", "WWW", 'W', TIN.wireFine(), 'I', IRON.ingot() });
		addRecipeAuto(new ItemStack(ModItems.coil_tin, 1), new Object[] { "WWW", "WIW", "WWW", 'W', TIN.wireFine(), 'I', STEEL.ingot() });
		...
		addRecipeAuto(new ItemStack(ModItems.coil_tungsten, 1), new Object[] { "WWW", "WIW", "WWW", 'W', W.wireFine(), 'I', IRON.ingot() });
		addRecipeAuto(new ItemStack(ModItems.coil_magnetized_tungsten, 1), new Object[] { "WWW", "WIW", "WWW", 'W', MAGTUNG.wireFine(), 'I', IRON.ingot() });
		addRecipeAuto(new ItemStack(ModItems.tank_steel, 2), new Object[] { "STS", "SHS", "STS", 'S', STEEL.plate(), 'T', TI.plate(), 'H', new ItemStack(ModItems.hammer, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModItems.motor, 2), new Object[] { "TRT", "CCC", "TRT", 'R', TIN.wireFine(), 'T', ModItems.bronze_parts, 'C', ModItems.coil_tin });
		...
		addRecipeAuto(new ItemStack(ModItems.bronze_parts, 1), new Object[] { "SSS", "S  ", "S  ", 'S', TBRONZE.plate() });
		...
		addShapelessAuto(new ItemStack(ModItems.powder_tin_bronze, 2), new Object[] { CU.dust(), CU.dust(), CU.dust(), TIN.dust() });
		addShapelessAuto(new ItemStack(ModItems.powder_tin_bronze, 2), new Object[] { CU.ore(), CU.ore(), CU.ore(), TIN.ore() });

		addRecipeAuto(new ItemStack(ModItems.wrench_flipped, 1), new Object[] { "S", "D", "W", 'S', Items.iron_sword, 'D', ModItems.ducttape, 'W', new ItemStack(ModItems.wrench, 1, 2) });
		...
		addShapelessAuto(new ItemStack(ModItems.cbt_device, 1), new Object[] { STEEL.bolt(), new ItemStack(ModItems.wrench, 1, 2) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.cable_switch, 1), new Object[] { "S ", "WC", 'S', Blocks.lever, 'W', ModBlocks.red_wire_coated, 'C', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE) });
		addRecipeAuto(new ItemStack(ModBlocks.cable_detector, 1), new Object[] { "S ", "WC", 'S', REDSTONE.dust(), 'W', ModBlocks.red_wire_coated, 'C', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addShapelessAuto(new ItemStack(ModBlocks.red_pylon_medium_wood_connector, 1), new Object[] { ModBlocks.red_pylon_medium_wood, ModItems.plate_polymer, ModItems.coil_copper, ModBlocks.red_connector });
		...
		addShapelessAuto(new ItemStack(ModBlocks.red_pylon_medium_steel_connector, 1), new Object[] { ModBlocks.red_pylon_medium_steel, ModItems.plate_polymer, ModItems.coil_copper, ModBlocks.red_connector });
		addRecipeAuto(new ItemStack(ModBlocks.red_pylon_medium_concrete, 2), new Object[] { "CCW", "IIW", "  S", 'C', ModItems.coil_copper, 'W', ModBlocks.concrete_smooth, 'I', ModItems.plate_polymer, 'S', KEY_COBBLESTONE });
		addRecipeAuto(new ItemStack(ModBlocks.red_pylon_medium_concrete, 2), new Object[] { "CCW", "IIW", "  S", 'C', ModItems.coil_copper, 'W', ModBlocks.concrete, 'I', ModItems.plate_polymer, 'S', KEY_COBBLESTONE });
		addShapelessAuto(new ItemStack(ModBlocks.red_pylon_medium_concrete_transformer, 1), new Object[] { ModBlocks.red_pylon_medium_concrete, ModItems.plate_polymer, ModItems.coil_copper });
		addShapelessAuto(new ItemStack(ModBlocks.red_pylon_medium_concrete_connector, 1), new Object[] { ModBlocks.red_pylon_medium_concrete, ModItems.plate_polymer, ModItems.coil_copper, ModBlocks.red_connector });
		addRecipeAuto(new ItemStack(ModBlocks.transformer_medium, 1), new Object[] { "CCC", "TTT", "SSS", 'C', ModItems.coil_copper, 'T', ModItems.coil_copper_torus, 'S', STEEL.plateCast() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_wood_burner, 1), new Object[] { "PPP", "CFC", "IHI" , 'P', STEEL.plate(), 'C', ModItems.coil_copper, 'I', IRON.ingot(), 'F', Blocks.furnace, 'H', new ItemStack(ModItems.hammer, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.crate_iron, 1), new Object[] { "PPP", "IWI", "III", 'P', IRON.plate(), 'I', IRON.ingot(), 'W',  new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		addRecipeAuto(new ItemStack(ModBlocks.crate_steel, 1), new Object[] { "PPP", "IWI", "III", 'P', STEEL.plate(), 'I', STEEL.ingot(), 'W',  new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.mass_storage, 1, 0), new Object[] { "WL ", "ICI", " IS", 'I', TI.ingot(), 'C', ModBlocks.crate_steel, 'L', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.VACUUM_TUBE), 'S', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		GameRegistry.addRecipe(new ContainerUpgradeCraftingHandler(new ItemStack(ModBlocks.mass_storage, 1, 1), new Object[] { "WC ", "PMP", " PS", 'P', DESH.ingot(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP), 'M', new ItemStack(ModBlocks.mass_storage, 1, 0), 'S', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) }));
		GameRegistry.addRecipe(new ContainerUpgradeCraftingHandler(new ItemStack(ModBlocks.mass_storage, 1, 2), new Object[] { "WC ", "PMP", " PS", 'P', ANY_RESISTANTALLOY.ingot(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ADVANCED), 'M', new ItemStack(ModBlocks.mass_storage, 1, 1), 'S', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) }));
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_press, 1), new Object[] { "WRG", "IPI", "GBS", 'I', IRON.ingot(), 'R', Blocks.furnace, 'B', IRON.block(), 'P', Blocks.piston, 'G', IRON.gear(), 'S', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.solar_mirror, 3), new Object[] { "AAA", "WBS", "SSS", 'A', AL.plate(), 'B', ModBlocks.steel_beam, 'S', STEEL.ingot(), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE), 'S', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_furnace_brick_off), new Object[] { "III", "IHI", "BBB", 'I', Items.brick, 'B', Blocks.stone, 'H', new ItemStack(ModItems.hammer, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_steam_multi, 1, SteamMachineType.FURNACE.ordinal()), new Object[] { "SES", "TCT", "SES", 'S', STEEL.plate(), 'C', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE), 'T', ModItems.tank_steel, 'E', TI.plate()  });
		addRecipeAuto(new ItemStack(ModBlocks.machine_steam_multi, 1, SteamMachineType.SHREDDER.ordinal()), new Object[] { "GES", "TCT", "SEG", 'S', STEEL.plate(), 'G', STEEL.gear(), 'C', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE), 'T', ModItems.tank_steel, 'E', ModItems.turbine_titanium });
		...
		addRecipeAuto(new ItemStack(ModItems.blades_tin, 1), new Object[] { " P ", "PIP", " P ", 'P', TIN.plate(), 'I', TIN.ingot() });
		addRecipeAuto(new ItemStack(ModItems.blades_bronze, 1), new Object[] { " P ", "PIP", " P ", 'P', TBRONZE.plate(), 'I', TBRONZE.ingot() });
		...
		addRecipeAuto(new ItemStack(ModItems.blades_tin, 1), new Object[] { "PIP", 'P', TIN.plate(), 'I', new ItemStack(ModItems.blades_tin, 1, OreDictionary.WILDCARD_VALUE) });
		addRecipeAuto(new ItemStack(ModItems.blades_bronze, 1), new Object[] { "PIP", 'P', TBRONZE.plate(), 'I', new ItemStack(ModItems.blades_bronze, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.spotlight_incandescent_powered_off, 8), new Object[] { "G", "T", "C", 'G', KEY_ANYPANE, 'T', W.wireFine(), 'C', ModItems.coil_tungsten });
		addRecipeAuto(new ItemStack(ModBlocks.spotlight_fluoro_powered_off, 8), new Object[] { "G", "M", "C", 'G', KEY_ANYPANE, 'M', ModItems.ingot_mercury, 'C', ModItems.coil_tungsten });
		addRecipeAuto(new ItemStack(ModBlocks.spotlight_halogen_powered_off, 8), new Object[] { "G", "B", "C", 'G', KEY_ANYPANE, 'B', ModItems.powder_bromine, 'C', ModItems.coil_tungsten });
		addRecipeAuto(new ItemStack(ModBlocks.powered_lights_controller, 1), new Object[] { "SCS", "CTC", "SCS", 'S', STEEL.plate(), 'C', ModItems.coil_tungsten, 'T', ModBlocks.machine_transformer });
	...
	public static void reg2() {
		...
		addShapelessAuto(new ItemStack(ModItems.gun_kit_2, 1), new Object[] { ModItems.gun_kit_1, new ItemStack(ModItems.wrench, 1, 2), ModItems.ducttape, Fluids.LUBRICANT.getDict(1_000) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.fluid_valve, 1), new Object[] { "S ", "WC", 'S', Blocks.lever, 'W', ModBlocks.fluid_duct_paintable, 'C', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE) });
		addRecipeAuto(new ItemStack(ModBlocks.fluid_switch, 1), new Object[] { "S ", "WC", 'S', REDSTONE.dust(), 'W', ModBlocks.fluid_duct_paintable, 'C', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE) });
		addRecipeAuto(new ItemStack(ModBlocks.fluid_counter_valve, 1), new Object[] { "S ", "WC", 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP), 'W', ModBlocks.fluid_switch, 'C', new ItemStack(ModItems.screwdriver, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.pneumatic_tube, 8), new Object[] { "CRC", " W ", 'C', TBRONZE.plateCast(), 'R', ANY_RUBBER.ingot(), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		addRecipeAuto(new ItemStack(ModBlocks.pneumatic_tube, 24), new Object[] { "CRC", " W ", 'C', TBRONZE.plateWelded(), 'R', ANY_RUBBER.ingot(), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.heat_pipe, 16), new Object[] { " C ", "CBC", " C ", 'C', CU.plateCast(), 'B', CU.block() });
		...
		if(!GeneralConfig.enable528) {
			addRecipeAuto(new ItemStack(ModItems.inf_water, 1), new Object[] { "222", "131", "222", '1', Fluids.WATER.getDict(1_000), '2', AL.plate(), '3', DIAMOND.gem() });
		...
		addRecipeAuto(new ItemStack(ModItems.photo_panel, 3), new Object[] { "WWW", "SSS", "WWW", 'S', SI.billet(), 'W', TIN.wireFine() });
		...
		addRecipeAuto(new ItemStack(ModItems.fence_gate, 1), new Object[] { "II", "II", "II", 'I', ModBlocks.fence_metal });
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_missile_assembly, 1), new Object[] { "PWP", "SSS", "CCC", 'P', ModItems.pedestal_steel, 'W', new ItemStack(ModItems.wrench, 1, 1), 'S', STEEL.plate(), 'C', ModBlocks.steel_scaffold });
		...
		addShapelessAuto(new ItemStack(ModBlocks.sand_mix, 8, EnumSandType.URANIUM.ordinal()), new Object[] { "sand", "sand", "sand", "sand", "sand", "sand", "sand", "sand", U.dust() });
		addShapelessAuto(new ItemStack(ModBlocks.sand_mix, 8, EnumSandType.POLONIUM.ordinal()), new Object[] { "sand", "sand", "sand", "sand", "sand", "sand", "sand", "sand", PO210.dust() });
		addShapelessAuto(new ItemStack(ModBlocks.sand_mix, 8, EnumSandType.BORON.ordinal()), new Object[] { "sand", "sand", "sand", "sand", "sand", "sand", "sand", "sand", B.dust() });
		addShapelessAuto(new ItemStack(ModBlocks.sand_mix, 8, EnumSandType.LEAD.ordinal()), new Object[] { "sand", "sand", "sand", "sand", "sand", "sand", "sand", "sand", PB.dust() });
		addShapelessAuto(new ItemStack(ModBlocks.sand_mix, 1, EnumSandType.QUARTZ.ordinal()), new Object[] { "sand", "sand", NETHERQUARTZ.dust(), NETHERQUARTZ.dust() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.barrel_iron, 1), new Object[] { "IPI", "IHI", "IPI", 'I', IRON.plate(), 'P', IRON.ingot(), 'H', new ItemStack(ModItems.hammer, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.barrel_lead, 1), new Object[] { "IPI", "ITI", "IPI", 'I', PB.plate(), 'P', STEEL.ingot(), 'T', ANY_TAR.any() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.rbmk_key_pad, 1), new Object[] { "R", "C", "B", 'R', ModBlocks.radio_torch_sender, 'B', ModBlocks.rbmk_display_blank, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.VACUUM_TUBE) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.rbmk_copper, 1), new Object[] { " C ", "CRC", " C ", 'C', CU.block(), 'R', ModBlocks.rbmk_blank });
		...
		addRecipeAuto(new ItemStack(ModBlocks.reactor_part, 1, ReactorPart.EJECTOR.ordinal()), "CLC", "MHM", "CLC", 'C', ModBlocks.brick_concrete, 'L', PB.plate(), 'M', ModItems.motor, 'H', new ItemStack(ModBlocks.reactor_part, 1, ReactorPart.HATCH.ordinal()));
		addRecipeAuto(new ItemStack(ModBlocks.reactor_part, 1, ReactorPart.INSERTER.ordinal()), "CLC", "MHM", "CLC", 'C', ModBlocks.brick_concrete, 'L', CU.plate(), 'M', ModItems.motor, 'H', new ItemStack(ModBlocks.reactor_part, 1, ReactorPart.HATCH.ordinal()));
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_condenser), new Object[] { "SCS", "IWI", "SCS", 'S', STEEL.ingot(), 'I', IRON.plate(), 'C', CU.plateCast(), 'W', new ItemStack(ModItems.wrench, 1, OreDictionary.WILDCARD_VALUE) });
		...
		if(GeneralConfig.enableLBSM && GeneralConfig.enableLBSMSimpleCrafting) {
			...
			addRecipeAuto(new ItemStack(ModItems.plate_nickel, 4), new Object[] { "##", "##", '#', NI.ingot() });
			addRecipeAuto(new ItemStack(ModItems.plate_stainless, 4), new Object[] { "##", "##", '#', STAINLESS.ingot() });
		...
		addRecipeAuto(Mats.MAT_TBRONZE.make(ModItems.gear), new Object[] { "BPB", "PWP", "BPB", 'B', TBRONZE.bolt(), 'P', TBRONZE.plate(), 'W', new ItemStack(ModItems.wrench, 1, 1) });
		addRecipeAuto(Mats.MAT_TBRONZE.make(ModItems.gear), new Object[] { "BPB", "PWP", "BPB", 'B', TBRONZE.bolt(), 'P', TBRONZE.plate(), 'W', new ItemStack(ModItems.wrench, 1, 2) });

		addRecipeAuto(Mats.MAT_IRON.make(ModItems.gear), new Object[] { "BPB", "PWP", "BPB", 'B', IRON.bolt(), 'P', IRON.plate(), 'W', new ItemStack(ModItems.wrench, 1, 1) });

		addRecipeAuto(Mats.MAT_STEEL.make(ModItems.gear), new Object[] { "BPB", "PWP", "BPB", 'B', STEEL.bolt(), 'P', STEEL.plate(), 'W', new ItemStack(ModItems.wrench, 1, 2) });

		addRecipeAuto(Mats.MAT_DURA.make(ModItems.gear), new Object[] { "BPB", "PWP", "BPB", 'B', DURA.bolt(), 'P', DURA.plate(), 'W', new ItemStack(ModItems.wrench, 1, 2) });
