...
public class MixingVatRecipeHandler extends TemplateRecipeHandler implements ICompatNHNEI {
	...
	public ItemStack[] getMachinesForRecipe() {
		return new ItemStack[]{
				new ItemStack(ModBlocks.machine_mixing_vat)};
	}
	...
	PositionedStack template;
		...
		public RecipeSet(MixingRecipe recipe) {
		...
		this.template = new PositionedStack(new ItemStack(ModItems.mixing_vat_template, 1, recipe.getId()), 84, 6);
		}
	...
	public String getGuiTexture() {
		return RefStrings.MODID + ":textures/gui/nei/gui_nei_mixing_vat.png";
	}

	@Override
	public void loadCraftingRecipes(String outputId, Object... results) {
		
		if((outputId.equals("mixing")) && getClass() == MixingVatRecipeHandler.class) {
			
			for(MixingRecipe recipe : MixingVatRecipes.recipes) {
	...
	public void loadUsageRecipes(String inputId, Object... ingredients) {
		if((inputId.equals("mixing")) && getClass() == MixingVatRecipeHandler.class) {
			loadCraftingRecipes("mixing", new Object[0]);
		} else {
	...
	public void loadTransferRects() {
		...
		transferRects.add(new RecipeTransferRect(new Rectangle(138 - 1 - 72, 23, 18 * 3, 18), "mixing"));
		transferRectsGui.add(new RecipeTransferRect(new Rectangle(18 * 2 + 2, 89 - 7 - 11, 18 * 5 - 4, 18 + 16), "mixing"));
		guiGui.add(GUIMachineMixingVat.class);
