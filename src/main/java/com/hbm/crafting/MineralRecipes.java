...
public class MineralRecipes {
	...
	public static void register() {
		...
		add1To9Pair(ModBlocks.block_tatb, ModItems.ball_tatb);
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.billet_pameu, 1), new Object[] { ModItems.nugget_pa230, ModItems.nugget_pa230, ModItems.nugget_pa230, ModItems.nugget_pa230, ModItems.nugget_pa230, ModItems.nugget_u233 });
		...
		GameRegistry.addRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_tin), 1), new Object[] { "###", "###", "###", '#', ModItems.ingot_tin });
		GameRegistry.addRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_nickel), 1), new Object[] { "###", "###", "###", '#', ModItems.ingot_nickel });
		...
		GameRegistry.addRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_green_salt), 1), new Object[] { "###", "###", "###", '#', ModItems.powder_green_salt });
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.hazmat, 1), new Object[] { "###", "###", "###", '#', ModItems.hazmat_cloth });

		GameRegistry.addRecipe(new ItemStack(ModItems.ingot_copper, 9), new Object[] { "#", '#', Item.getItemFromBlock(ModBlocks.block_copper) });
		GameRegistry.addRecipe(new ItemStack(ModItems.ingot_tin, 9), new Object[] { "#", '#', Item.getItemFromBlock(ModBlocks.block_tin) });
		GameRegistry.addRecipe(new ItemStack(ModItems.ingot_nickel, 9), new Object[] { "#", '#', Item.getItemFromBlock(ModBlocks.block_nickel) });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.powder_green_salt, 9), new Object[] { "#", '#', Item.getItemFromBlock(ModBlocks.block_green_salt) });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.hazmat_cloth, 9), new Object[] { "#", '#', ModBlocks.hazmat });
