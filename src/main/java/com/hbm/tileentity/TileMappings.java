...
import com.hbm.blocks.network.pneumatic.PneumoTubePaintableBlock.TileEntityPneumoTubePaintable;
...
public class TileMappings {
	...
	public static void writeMappings() {
		...
		put(TileEntityMachineRadTank.class, "tileentity_rad_tank");
		...
		put(TileEntityMachineAdvancedCentrifuge.class, "tileentity_machine_advanced_centrifuge");
		put(TileEntityMachineMixingVat.class, "tileentity_machine_mixing_vat");
	...
	private static void putMachines() {
		...
		put(TileEntityMachineAlkylation.class, "tileentity_alkylation");
	...
	private static void putRBMK() {
		...
		put(TileEntityRBMKCopper.class, "tileentity_rbmk_copper");
