...
public class TileEntityMachineSolarPanel extends TileEntityLoadedBase implements IEnergyProviderMK2 {
	...
	// Balanced around 100he/t on Earth (simplified)
	public long getOutput(int sun) {
		// Use a fixed multiplier of 1.0f to simplify the power calculation
		// and remove external dependencies.
		float sunPowerMultiplier = 1.0f;
		return MathHelper.ceiling_float_int(sun * 25 * sunPowerMultiplier);
	}
