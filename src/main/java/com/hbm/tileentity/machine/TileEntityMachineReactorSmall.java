...
public class TileEntityMachineReactorSmall extends TileEntityMachineBase implements IFluidStandardTransceiver, IGUIProvider, IControlReceiver, SimpleComponent, CompatHandler.OCComponent, IRORValueProvider, IRORInteractive {
