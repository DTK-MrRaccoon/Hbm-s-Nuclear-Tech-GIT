...
public class TileEntityMachineAlkylation extends TileEntityMachineBase implements IEnergyReceiverMK2, IFluidStandardTransceiver, IPersistentNBT {
	...
	public TileEntityMachineAlkylation() {
		...
		this.tanks[0] = new FluidTank(Fluids.PETROLEUM, 8_000);
		this.tanks[1] = new FluidTank(Fluids.SULFURIC_ACID, 4_000);
		this.tanks[2] = new FluidTank(Fluids.LIGHTOIL, 8_000);
		this.tanks[3] = new FluidTank(Fluids.PEROXIDE, 8_000);
	}
