...
public class MobUtil {
	...
	public static void intializeMobPools(){
		...
		slotPoolGunsTier2.put(0, createSlotPool(0, new Object[][]{
			{ModItems.gun_uzi, 12}, {ModItems.gun_maresleg, 8}, {ModItems.gun_henry, 12}, {ModItems.gun_heavy_revolver, 8}, {ModItems.gun_flaregun, 4}
		}));

		slotPoolGunsTier3.put(0, createSlotPool(0, new Object[][]{
			{ModItems.gun_g3, 25}, {ModItems.gun_spas12, 20}, {ModItems.gun_carbine, 15}, {ModItems.gun_am180, 6}, {ModItems.gun_amat, 5}
		}));
