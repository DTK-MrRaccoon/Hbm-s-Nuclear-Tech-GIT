	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float i) {
		...
		if(te instanceof TileEntityBarrel) {
			...
			if(type != Fluids.NONE) {
		        ...
		        if(te.getBlockType() == ModBlocks.barrel_iron)
		            bindTexture(ResourceManager.barrel_iron_tex);
		        if(te.getBlockType() == ModBlocks.barrel_corroded)
		            bindTexture(ResourceManager.barrel_corroded_tex);
		        else if(te.getBlockType() == ModBlocks.barrel_steel)
		            bindTexture(ResourceManager.barrel_steel_tex);
		        if(te.getBlockType() == ModBlocks.barrel_lead)
		            bindTexture(ResourceManager.barrel_lead_tex);
