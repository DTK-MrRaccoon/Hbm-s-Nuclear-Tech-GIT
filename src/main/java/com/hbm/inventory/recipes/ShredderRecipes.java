...
public class ShredderRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		ShredderRecipes.setRecipe(ModItems.bean_roast,  new ItemStack(ModItems.powder_coffee, 2));
		...
		ShredderRecipes.setRecipe(ModBlocks.ore_nickel, DictFrame.fromOne(ModItems.chunk_ore, EnumChunkType.PENTLANDITE, 2));
		...
		ShredderRecipes.setRecipe(ModItems.crystal_tin, new ItemStack(ModItems.powder_tin, 3));
		...
		ShredderRecipes.setRecipe(ModItems.coil_tin, new ItemStack(ModItems.powder_tin, 1));
		...
		ShredderRecipes.setRecipe(ModItems.can_key,  new ItemStack(ModItems.powder_steel_tiny, 1));
