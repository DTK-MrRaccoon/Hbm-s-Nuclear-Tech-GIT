...
public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_chemplant, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 6), new OreDictStack(CU.pipe(), 1), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.coil_tungsten, 1), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.BASIC) }, 150);
