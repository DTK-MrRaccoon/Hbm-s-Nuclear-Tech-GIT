...
public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.block_tritium, 1), new AStack[] {new ComparableStack(ModItems.cell_tritium, 16), },3000);
		makeRecipe(new ComparableStack(ModItems.cell_tritium, 16), new AStack[] {new ComparableStack(ModBlocks.block_tritium, 1), },3000);
		makeRecipe(new ComparableStack(ModItems.centrifuge_element, 1), new AStack[] {new OreDictStack(STEEL(), 4), new OreDictStack(TI(), 4), new ComparableStack(ModItems.motor, 1), }, 100);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_centrifuge, 1), new AStack[] {new ComparableStack(ModItems.centrifuge_element, 1), new OreDictStack(ANY_PLASTIC.ingot(), 2), new OreDictStack(STEEL(), 8), new OreDictStack(CU.plate(), 8), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ANALOG), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_gascent, 1), new AStack[] {new ComparableStack(ModItems.centrifuge_element, 4), new OreDictStack(ANY_PLASTIC.ingot(), 4), new OreDictStack(DESH.ingot(), 2), new OreDictStack(STEEL(), 8), new ComparableStack(ModItems.coil_tungsten, 4), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ADVANCED.ordinal()) }, 300);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_rtg_grey, 1), new AStack[] {new ComparableStack(ModItems.rtg_unit, 3), new OreDictStack(STEEL(), 4), new OreDictStack(MINGRADE.wireFine(), 4), new OreDictStack(ANY_PLASTIC.ingot(), 3), },200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_shredder, 1), new AStack[] {new OreDictStack(STEEL(), 8), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModBlocks.steel_beam, 2), new ComparableStack(Blocks.iron_bars, 2) },200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_chemplant, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 6), new OreDictStack(CU.plate(), 2), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ANALOG) }, 150);
		makeRecipe(new ComparableStack(ModBlocks.machine_chemplant, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 6), new OreDictStack(CU.pipe(), 1), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.coil_tungsten, 1), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ANALOG) }, 150);
		makeRecipe(new ComparableStack(ModBlocks.machine_assemfac, 1), new AStack[] {!exp ? new OreDictStack(STEEL.ingot(), 48) : new OreDictStack(STEEL.heavyComp(), 2), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 8), new OreDictStack(B.ingot(), 4), new OreDictStack(RUBBER.ingot(), 16), new OreDictStack(KEY_ANYPANE, 64), new ComparableStack(ModItems.motor, 18), new OreDictStack(W.bolt(), 16), new OreDictStack(STEEL.pipe(), 8), new ComparableStack(ModItems.circuit, 16, EnumCircuitType.BASIC) }, 400);
		makeRecipe(new ComparableStack(ModBlocks.machine_chemfac, 1), new AStack[] {!exp ? new OreDictStack(STEEL.ingot(), 48) : new OreDictStack(STEEL.heavyComp(), 2), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 8), new OreDictStack(NB.ingot(), 4), new OreDictStack(RUBBER.ingot(), 16), new OreDictStack(STEEL.shell(), 12), new ComparableStack(ModItems.tank_steel, 8), new ComparableStack(ModItems.motor_desh, 4), new ComparableStack(ModItems.coil_tungsten, 24), new OreDictStack(STEEL.pipe(), 8), new ComparableStack(ModItems.circuit, 16, EnumCircuitType.BASIC) }, 400);
                makeRecipe(new ComparableStack(ModBlocks.machine_industrial_generator, 1), new AStack[] {new ComparableStack(ModItems.piston_selenium, 4), new OreDictStack(STEEL.plateCast(), 6), new ComparableStack(ModItems.tank_steel, 3), new OreDictStack(ANY_RUBBER.ingot(), 8), new ComparableStack(ModItems.rtg_unit, 12), new ComparableStack(ModItems.thermo_element, 4), new ComparableStack(ModItems.circuit, 4, EnumCircuitType.ANALOG) }, 800);
		makeRecipe(new ComparableStack(ModBlocks.machine_drill, 1), new AStack[] {new ComparableStack(ModBlocks.steel_scaffold, 16), new OreDictStack(STEEL.plateWelded(), 4), new OreDictStack(TI.ingot(), 32), new ComparableStack(ModItems.motor, 4), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.VACUUM_TUBE) }, 300);
		makeRecipe(new ComparableStack(ModBlocks.machine_reactor_small, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 8), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 4), new OreDictStack(B.ingot(), 12), new OreDictStack(GRAPHITE.ingot(), 12), new OreDictStack(PB.plate(), 8), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.circuit, 2, EnumCircuitType.BASIC), },300);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_fluidtank, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 2), new OreDictStack(STEEL(), 6), new OreDictStack(STEEL.shell(), 4), new OreDictStack(ANY_TAR.any(), 4), },150);
		makeRecipe(new ComparableStack(ModBlocks.machine_bat9000, 1), new AStack[] {new OreDictStack(STEEL(), 16), new OreDictStack(ANY_RESISTANTALLOY.plateWelded(), 2), new ComparableStack(ModBlocks.steel_scaffold, 16), new OreDictStack(ANY_TAR.any(), 16), },150);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_teleporter, 1), new AStack[] {new OreDictStack(TI.ingot(), 8), new OreDictStack(ALLOY(), 12), new OreDictStack(GOLD.wireFine(), 32), new ComparableStack(ModItems.entanglement_kit, 1), new ComparableStack(ModBlocks.machine_battery, 1) },300);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_center, 1), new AStack[] {new OreDictStack(ANY_HARDPLASTIC.ingot(), 4), new OreDictStack(STEEL(), 6), new OreDictStack(ALLOY.wireFine(), 24), },200);
		...
		makeRecipe(new ComparableStack(ModItems.boy_shielding, 1), new AStack[] {new OreDictStack(OreDictManager.getReflector(), 12), new OreDictStack(STEEL(), 4), },150);
		...
		makeRecipe(new ComparableStack(ModItems.boy_propellant, 1), new AStack[] {new ComparableStack(ModItems.cordite, 8), new OreDictStack(IRON(), 8), new OreDictStack(AL(), 4), new OreDictStack(MINGRADE.wireFine(), 4), },100);
		makeRecipe(new ComparableStack(ModItems.boy_igniter, 1), new AStack[] {new OreDictStack(ANY_HIGHEXPLOSIVE.ingot(), 1), new OreDictStack(AL(), 6), new OreDictStack(STEEL(), 1), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ADVANCED.ordinal()), new OreDictStack(MINGRADE.wireFine(), 3), },150); //HE for gating purposes
		makeRecipe(new ComparableStack(ModItems.man_igniter, 1), new AStack[] {new OreDictStack(STEEL(), 6), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ADVANCED.ordinal()), new OreDictStack(MINGRADE.wireFine(), 9), },150);
		...
		makeRecipe(new ComparableStack(ModItems.mike_deut, 1), new AStack[] {new OreDictStack(IRON(), 12), new OreDictStack(STEEL(), 16), new ComparableStack(ModItems.cell_deuterium, 10), },200);
		makeRecipe(new ComparableStack(ModItems.mike_cooling_unit, 1), new AStack[] {new OreDictStack(IRON(), 8), new ComparableStack(ModItems.coil_copper, 5), new ComparableStack(ModItems.coil_tungsten, 5), new ComparableStack(ModItems.motor, 2), },200);
		makeRecipe(new ComparableStack(ModItems.fleija_igniter, 1), new AStack[] {new OreDictStack(TI(), 6), new OreDictStack(SA326.wireFine(), 2), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ADVANCED.ordinal()), },300);
		...
		makeRecipe(new ComparableStack(ModItems.solinium_igniter, 1), new AStack[] {new OreDictStack(TI(), 4), new OreDictStack(ALLOY.wireFine(), 2), new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ADVANCED.ordinal()), new ComparableStack(ModItems.coil_gold, 1), },400);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_large_turbine, 1), new AStack[] {
				!exp ? new OreDictStack(STEEL(), 12) : new OreDictStack(STEEL.heavyComp(), 1),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_chungus, 1), new AStack[] {
				...
				!exp ? new OreDictStack(TI(), 12) : new OreDictStack(TI.heavyComp(), 1),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_condenser_powered, 1), new AStack[] {
				...
				!exp ? new OreDictStack(CU(), 16) : new OreDictStack(CU.heavyComp(), 3),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_cyclotron, 1), new AStack[] {
				...
				new OreDictStack(STEEL(), 32),
				new OreDictStack(AL(), 32),
		...
		makeRecipe(new ComparableStack(ModBlocks.rbmk_blank, 1), new AStack[] {
				...
				!exp ? new OreDictStack(STEEL(), 4) : new OreDictStack(STEEL.plateCast(), 16),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_vacuum_distill, 1), new AStack[] {
				...
				!exp ? new OreDictStack(CU(), 16) : new OreDictStack(CU.heavyComp(), 4),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_catalytic_reformer, 1), new AStack[] {
				...
				!exp ? new OreDictStack(CU(), 8) : new OreDictStack(CU.heavyComp(), 2),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_electrolyser, 1), new AStack[] {
				...
				!exp ? new OreDictStack(CU(), 16) : new OreDictStack(CU.heavyComp(), 1),
				new OreDictStack(RUBBER.ingot(), 8),
				new OreDictStack(STEEL.shell(), 3),
				new ComparableStack(ModItems.ingot_firebrick, 16),
