...
public class CrystallizerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		registerRecipe(new OreDictStack(ZI.ore()),		new CrystallizerRecipe(ModItems.crystal_zinc, baseTime).prod(0.05F));
		...
		registerRecipe(new ComparableStack(ModItems.nickel_salts),	new CrystallizerRecipe(ModItems.crystal_nickel, baseTime));
		...
		for(BedrockOreType type : BedrockOreType.values()) {
			...
			registerRecipe(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.CRUMBS, type)), new CrystallizerRecipe(ItemBedrockOreNew.make(BedrockOreGrade.BASE, type), bedrock).setReq(48), new FluidStack(Fluids.SLOP, 1000));
