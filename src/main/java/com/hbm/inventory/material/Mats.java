...
public class Mats {
	...
	public static final NTMMaterial MAT_TBRONZE		= makeSmeltable(_AS + 21,	TBRONZE,		0xEDAF5D, 0x8A1600, 0xE37E3A).setAutogen(BOLT, DUST, PLATE, CASTPLATE, WELDEDPLATE, SHELL).m();
