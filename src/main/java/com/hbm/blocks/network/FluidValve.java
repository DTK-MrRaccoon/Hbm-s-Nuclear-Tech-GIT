...
public class FluidValve extends FluidDuctBase implements ILookOverlay {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconOnDamaged = iconRegister.registerIcon(RefStrings.MODID + ":fluid_valve_on_damaged");
		this.iconOffDamaged = iconRegister.registerIcon(RefStrings.MODID + ":fluid_valve_off_damaged");
	}
