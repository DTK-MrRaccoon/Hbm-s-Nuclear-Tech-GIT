...
public class BlockOre extends Block {
	...
	public boolean canSilkHarvest(World world, EntityPlayer player, int x, int y, int z, int meta) {
		// Disable silk touch for both oil ores
		if(this == ModBlocks.ore_oil || this == ModBlocks.ore_oil_rus) return false;
	...
	public Item getItemDropped(int i, Random rand, int j) {
		...
		// Both oil ores drop tar
		if(this == ModBlocks.ore_oil || this == ModBlocks.ore_oil_rus) {
			return ModItems.oil_tar;
		}
	...
	public int quantityDropped(Random rand) {
		...
		// Russian oil ore drops 2x tar compared to normal oil
		if(this == ModBlocks.ore_oil_rus) return 2;
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block block) {
		...
		// Allow both oil ores to swap with empty ore below
		if (below == ModBlocks.ore_oil_empty && (self == ModBlocks.ore_oil || self == ModBlocks.ore_oil_rus)) {
