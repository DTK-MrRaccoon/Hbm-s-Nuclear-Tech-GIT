...
public class MachineKrusty extends BlockContainer implements IMultiblock, ILookOverlay {
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(ModBlocks.machine_krusty);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(world.isRemote) {
			...
			TileEntityMachineKrusty entity = (TileEntityMachineKrusty) world.getTileEntity(x, y, z);
			if(entity != null) {
	...
	public void printHook(Pre event, World world, int x, int y, int z) {
		...
		int heat = (int) Math.round(krusty.heat * 0.00002 * 980 + 20);
		int power = (int) krusty.power;
		...
		text.add(EnumChatFormatting.RED + "Heat: " + EnumChatFormatting.RESET + heat + "C");
		...
		text.add(EnumChatFormatting.GOLD + "Power: " + EnumChatFormatting.RESET + BobMathUtil.getShortNumber(power) + "/" + BobMathUtil.getShortNumber(maxPower) + "HE");
