...
public class ModBlocks {
	...
	public static Block block_green_salt;
	...
	public static Block block_tatb;
	...
	public static Block concrete_smooth_cracked;
	...
	public static Block machine_advanced_centrifuge;
	...
	public static Block red_pylon_medium_wood_connector;
	...
	public static Block transformer_medium;
	...
	public static Block barrel_lead;
	...
	public static Block reactor_part;
	...
	public static Block machine_mixing_vat;
	...
	public static Block rbmk_copper;
	...
	private static void initializeBlock() {
		...
		block_green_salt = new BlockHazardFalling().makeBeaconable().setBlockName("block_green_salt").setCreativeTab(MainRegistry.blockTab).setStepSound(Block.soundTypeSand).setHardness(5.0F).setResistance(10.0F).setBlockTextureName(RefStrings.MODID + ":block_green_salt");
		...
		block_tatb = new BlockPlasticExplosive(Material.tnt).setBlockName("block_tatb").setCreativeTab(MainRegistry.blockTab).setStepSound(Block.soundTypeMetal).setHardness(2.0F).setResistance(2.0F).setBlockTextureName(RefStrings.MODID + ":block_tatb");
		...
		deco_stainless = new BlockDecoCT(Material.iron).setBlockName("deco_stainless").setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(10.0F).setBlockTextureName(RefStrings.MODID + ":deco_stainless");
		...
		reinforced_brick = new BlockGeneric(Material.rock).setBlockName("reinforced_brick").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(110.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_brick");
		...
		reinforced_glass_pane = new BlockNTMGlassPane(0, RefStrings.MODID + ":reinforced_glass_pane", RefStrings.MODID + ":reinforced_glass_pane_edge", Material.rock, false).setBlockName("reinforced_glass_pane").setCreativeTab(MainRegistry.blockTab).setLightOpacity(1).setHardness(2.0F).setResistance(20.0F);
		reinforced_light = new BlockGeneric(Material.rock).setBlockName("reinforced_light").setCreativeTab(MainRegistry.blockTab).setLightLevel(1.0F).setHardness(15.0F).setResistance(25.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_light");
		reinforced_sand = new BlockGeneric(Material.rock).setBlockName("reinforced_sand").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(10.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_sand");
		reinforced_lamp_off = new ReinforcedLamp(Material.rock, false).setBlockName("reinforced_lamp_off").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(25.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_lamp_off");
		reinforced_lamp_on = new ReinforcedLamp(Material.rock, true).setBlockName("reinforced_lamp_on").setHardness(15.0F).setResistance(25.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_lamp_on");
		reinforced_laminate = new BlockNTMGlassCT(1, RefStrings.MODID + ":reinforced_laminate", Material.rock, true).setBlockName("reinforced_laminate").setCreativeTab(MainRegistry.blockTab).setLightOpacity(0).setHardness(15.0F).setResistance(90.0F);
		reinforced_laminate_pane = new BlockNTMGlassPane(1, RefStrings.MODID + ":reinforced_laminate_pane", RefStrings.MODID + ":reinforced_laminate_pane_edge", Material.rock, true).setBlockName("reinforced_laminate_pane").setCreativeTab(MainRegistry.blockTab).setLightOpacity(1).setHardness(15.0F).setResistance(45.0F);
		...
		reinforced_stone = new BlockGeneric(Material.rock).setBlockName("reinforced_stone").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(40.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_stone");
		concrete_smooth = new BlockConcreteDamagable(Material.rock).setBlockName("concrete_smooth").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(60.0F).setBlockTextureName(RefStrings.MODID + ":concrete");
		...
		concrete_pillar = new BlockRotatablePillar(Material.rock, RefStrings.MODID + ":concrete_pillar_top").setBlockName("concrete_pillar").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(175.0F).setBlockTextureName(RefStrings.MODID + ":concrete_pillar_side");
		brick_concrete = new BlockConcreteDamagable(Material.rock).setBlockName("brick_concrete").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(100.0F).setBlockTextureName(RefStrings.MODID + ":brick_concrete");
		brick_concrete_mossy = new BlockConcreteDamagable(Material.rock).setBlockName("brick_concrete_mossy").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(100.0F).setBlockTextureName(RefStrings.MODID + ":brick_concrete_mossy");
		brick_concrete_cracked = new BlockConcreteDamagable(Material.rock).setBlockName("brick_concrete_cracked").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(75.0F).setBlockTextureName(RefStrings.MODID + ":brick_concrete_cracked");
		brick_concrete_broken = new BlockConcreteDamagable(Material.rock).setBlockName("brick_concrete_broken").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(45.0F).setBlockTextureName(RefStrings.MODID + ":brick_concrete_broken");
		brick_concrete_marked = new BlockWriting(Material.rock, RefStrings.MODID + ":brick_concrete").setBlockName("brick_concrete_marked").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(100.0F).setBlockTextureName(RefStrings.MODID + ":brick_concrete_marked");
		brick_obsidian = new BlockGeneric(Material.rock).setBlockName("brick_obsidian").setCreativeTab(MainRegistry.blockTab).setLightOpacity(15).setHardness(15.0F).setResistance(60.0F).setBlockTextureName(RefStrings.MODID + ":brick_obsidian");
		...
		brick_compound = new BlockGeneric(Material.rock).setBlockName("brick_compound").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(200.0F).setBlockTextureName(RefStrings.MODID + ":brick_compound");
		...
		reinforced_ducrete = new BlockGeneric(Material.rock).setBlockName("reinforced_ducrete").setCreativeTab(MainRegistry.blockTab).setHardness(20.0F).setResistance(500.0F).setBlockTextureName(RefStrings.MODID + ":reinforced_ducrete");
		...
		radsensor = new RadSensor(Material.iron).setBlockName("radsensor").setCreativeTab(MainRegistry.machineTab).setHardness(15.0F).setResistance(0.25F).setBlockTextureName(RefStrings.MODID + ":radsensor");
		...
		crop_strawberry = new BlockCrop(Blocks.farmland, true).setBlockName("crop_strawberry").setStepSound(Block.soundTypeGrass).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":strawberry");
		crop_coffee = new BlockCrop(Blocks.farmland, true).setBlockName("crop_coffee").setStepSound(Block.soundTypeGrass).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":coffee");
		crop_tea = new BlockCrop(Blocks.farmland, true).setBlockName("crop_tea").setStepSound(Block.soundTypeGrass).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":tea");
		...
		tatb = new BlockTATB().setBlockName("tatb").setStepSound(Block.soundTypeGrass).setCreativeTab(MainRegistry.nukeTab).setHardness(0.0F).setBlockTextureName(RefStrings.MODID + ":tatb");
		...
		machine_advanced_centrifuge = new MachineAdvancedCentrifuge(Material.iron).setBlockName("machine_advanced_centrifuge").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel");
		...
		machine_industrial_generator = new MachineIGenerator(Material.iron).setBlockName("machine_industrial_generator").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel");
		...
		transformer_medium = new TransformerMedium(Material.iron).setBlockName("transformer_medium").setHardness(5.0F).setResistance(30.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel");
		...
		heat_pipe = new HeatPipe().setBlockName("heat_pipe").setStepSound(ModSoundTypes.pipe).setCreativeTab(MainRegistry.machineTab).setHardness(3.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":fluid_duct_box");
		...
		barrel_corroded = new BlockFluidBarrel(Material.iron, 12000).setBlockName("barrel_corroded").setStepSound(Block.soundTypeMetal).setHardness(2.0F).setResistance(5.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":barrel_corroded");
		barrel_iron = new BlockFluidBarrel(Material.iron, 16000).setBlockName("barrel_iron").setStepSound(Block.soundTypeMetal).setHardness(2.0F).setResistance(5.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":barrel_iron");
		barrel_steel = new BlockFluidBarrel(Material.iron, 24000).setBlockName("barrel_steel").setStepSound(Block.soundTypeMetal).setHardness(2.0F).setResistance(5.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":barrel_steel");
		barrel_lead = new BlockFluidBarrel(Material.iron, 8000).setBlockName("barrel_lead").setStepSound(Block.soundTypeMetal).setHardness(2.0F).setResistance(5.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":barrel_lead");
		barrel_tcalloy = new BlockFluidBarrel(Material.iron, 32000).setBlockName("barrel_tcalloy").setStepSound(Block.soundTypeMetal).setHardness(2.0F).setResistance(5.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":barrel_tcalloy");
		...
		reactor_part = new BlockReactorPart().setBlockName("reactor_part").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab);
		...
		fence_gate = new BlockFenceGate(Material.iron).setBlockName("fence_gate").setHardness(5.0F).setResistance(1.0F).setBlockTextureName(RefStrings.MODID + ":fence_metal");
		...
		rbmk_copper = new RBMKCopper().setBlockName("rbmk_copper").setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":rbmk/rbmk_copper");
	...
	private static void registerBlock() {
		...
		GameRegistry.registerBlock(ore_oil_rus, ore_oil_rus.getUnlocalizedName());
		...
		GameRegistry.registerBlock(block_green_salt, block_green_salt.getUnlocalizedName());
		...
		GameRegistry.registerBlock(block_tatb, block_tatb.getUnlocalizedName());
		...
		GameRegistry.registerBlock(concrete_smooth_cracked, ItemBlockBlastInfo.class, concrete_smooth_cracked.getUnlocalizedName());
		...
		GameRegistry.registerBlock(tatb, tatb.getUnlocalizedName());
		...
		//Rad Sensor
		GameRegistry.registerBlock(radsensor, radsensor.getUnlocalizedName());
		...
		GameRegistry.registerBlock(fence_gate, fence_gate.getUnlocalizedName());
		...
		GameRegistry.registerBlock(machine_advanced_centrifuge, machine_advanced_centrifuge.getUnlocalizedName());
		...
		GameRegistry.registerBlock(rbmk_copper, rbmk_copper.getUnlocalizedName());
		...
		register(red_pylon_medium_wood_connector);
