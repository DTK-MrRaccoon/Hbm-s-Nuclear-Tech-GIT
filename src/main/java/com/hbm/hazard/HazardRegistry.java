...
public class HazardRegistry {
	...
	public static void registerItems() {
		...
		HazardSystem.register(stick_tatb, makeData(EXPLOSIVE, 1.5F));
		...
		HazardSystem.register(rod_zirnox_u234_depleted, makeData(RADIATION, wst * rod_dual * 5F));
		...
		registerOtherWaste(waste_u234, wst * billet);
		...
		registerBreedingRodRadiation(BreedingRodType.MOX_FUEL, mox);
		registerBreedingRodRadiation(BreedingRodType.PLUTONIUM_FUEL, purg);
		registerBreedingRodRadiation(BreedingRodType.URANIUM_FUEL, uf);
		registerBreedingRodRadiation(BreedingRodType.U233, u233);
		registerBreedingRodRadiation(BreedingRodType.LES, saf);
		registerBreedingRodRadiation(BreedingRodType.SCHRABIDIUM, saf);
		registerBreedingRodRadiation(BreedingRodType.SOLINIUM, sa327);
		...
		registerRBMKRod(rbmk_fuel_hea243, am243 * rod_rbmk, wst * rod_rbmk * 33F);
		...
		registerRBMKPellet(rbmk_pellet_hea243, am243 * billet, wst * billet * 33F);
		...
		HazardSystem.register(powder_green_salt, makeData(RADIATION, yc * powder));
		HazardSystem.register(block_green_salt, makeData(RADIATION, yc * block * powder_mult));
	...
	private static void registerBreedingRodRadiation(BreedingRodType type, float base) {
		HazardData standardData = makeData().addEntry(RADIATION, base / 2);
		HazardData dualData = makeData().addEntry(RADIATION, base * rod_dual);
		HazardData quadData = makeData().addEntry(RADIATION, base * rod_quad);

		if(type == BreedingRodType.LES || type == BreedingRodType.SCHRABIDIUM || type == BreedingRodType.SOLINIUM) {
			standardData.addEntry(BLINDING, 20F / 2);
			dualData.addEntry(BLINDING, 20F * rod_dual);
			quadData.addEntry(BLINDING, 20F * rod_quad);
		}
		HazardSystem.register(new ItemStack(ModItems.rod, 1, type.ordinal()), standardData);
		HazardSystem.register(new ItemStack(ModItems.rod_dual, 1, type.ordinal()), dualData);
		HazardSystem.register(new ItemStack(ModItems.rod_quad, 1, type.ordinal()), quadData);
	}
