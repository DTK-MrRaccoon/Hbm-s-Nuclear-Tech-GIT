...
public class ModItems {
	...
	public static Item billet_u234;
	...
	public static Item billet_pameu;
	...
	public static Item nugget_u234;
	...
	public static Item nugget_pa230;
	...
	public static Item powder_green_salt;
	...
	public static Item stamp_steel_gear;
	...
	public static Item rod_zirnox_u234_depleted;
	...
	public static Item pile_rod_thorium;
	public static Item pile_rod_thorium_fuel;
	...
	public static ItemRBMKRod rbmk_fuel_hep242;
	public static ItemRBMKRod rbmk_fuel_mepg;
	...
	public static ItemRBMKRod rbmk_fuel_hea243;
	...
	public static ItemRBMKRod rbmk_fuel_pameu;
	...
	public static ItemRBMKPellet rbmk_pellet_hep242;
	public static ItemRBMKPellet rbmk_pellet_mepg;
	...
	public static ItemRBMKPellet rbmk_pellet_hea243;
	...
	public static ItemRBMKPellet rbmk_pellet_pameu;
	...
	public static Item mixing_vat_template;
	public static Item mixing_vat_icon;
	...
	public static void initializeItem() {
		...
		ingot_u234 = new Item().setUnlocalizedName("ingot_u234").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ingot_u234");
		...
		ingot_pu242 = new Item().setUnlocalizedName("ingot_pu242").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ingot_pu242");
		...
		ingot_am243 = new Item().setUnlocalizedName("ingot_am243").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ingot_am243");
		...
		ingot_nickel = new Item().setUnlocalizedName("ingot_nickel").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ingot_nickel");
		...
		gear = new ItemAutogen(MaterialShapes.GEAR).oun("gearntm").setUnlocalizedName("gear").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":gear");
		...
		billet_u234 = new Item().setUnlocalizedName("billet_u234").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":billet_u234");
		...
		billet_pu242 = new Item().setUnlocalizedName("billet_pu242").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":billet_pu242");
		...
		billet_am243 = new Item().setUnlocalizedName("billet_am243").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":billet_am243");
		...
		billet_pameu = new Item().setUnlocalizedName("billet_pameu").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":billet_pameu");
		...
		nugget_nickel = new ItemCustomLore().setUnlocalizedName("nugget_nickel").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":nugget_nickel");
		...
		s_cream	= new ItemLemon(8, 1.0F, false).setUnlocalizedName("s_cream").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":ice_cream_s");
		...
		nugget_u234 = new Item().setUnlocalizedName("nugget_u234").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":nugget_u234");
		...
		nugget_pu242 = new Item().setUnlocalizedName("nugget_pu242").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":nugget_pu242");
		...
		nugget_am243 = new Item().setUnlocalizedName("nugget_am243").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":nugget_am243");
		...
		nugget_pa230 = new Item().setUnlocalizedName("nugget_pa230").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":nugget_pa230");
		...
		plate_nickel = new Item().setUnlocalizedName("plate_nickel").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":plate_nickel");
		...
		powder_green_salt = new Item().setUnlocalizedName("powder_green_salt").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_green_salt");
		...
		nickel_salts = new Item().setUnlocalizedName("nickel_salts").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":nickel_salts");
		...
		stamp_steel_gear = new ItemStamp(192, StampType.GEAR).setUnlocalizedName("stamp_steel_gear").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setTextureName(RefStrings.MODID + ":stamp_steel_gear");
		...
		wire_fine = new ItemAutogen(MaterialShapes.WIRE)
				...
				.aot(Mats.MAT_TIN, "wire_tin").aot(Mats.MAT_SOLDER, "wire_solder").aot(Mats.MAT_ZINC, "wire_zinc")
		...
		strawberry = new ItemSeedFood(3, 0.4F, ModBlocks.crop_strawberry, Blocks.farmland).setUnlocalizedName("strawberry").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":strawberry");
		bean_raw = new ItemSeedFood(1, 0.2F, ModBlocks.crop_coffee, Blocks.farmland).setUnlocalizedName("bean_raw").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":coffeebeanraw");
		...
		bean_roast = new Item().setUnlocalizedName("bean_roast").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":coffeebeanroast");
		...
		teaseeds = new ItemSeedFood(0, 0, ModBlocks.crop_tea, Blocks.farmland).setUnlocalizedName("teaseeds").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":teaseeds");
		tea_leaf = new Item().setUnlocalizedName("tea_leaf").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":tea_leaf");
		...
		rod_zirnox_u234_depleted = new Item().setUnlocalizedName("rod_zirnox_u234_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.rod_zirnox_empty).setTextureName(RefStrings.MODID + ":rod_zirnox_u234_depleted");
		...
		waste_u234 = new ItemDepletedFuel().setUnlocalizedName("waste_u234").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":waste_uranium");
		...
		pile_rod_thorium = new ItemPileRod().setUnlocalizedName("pile_rod_thorium").setCreativeTab(MainRegistry.controlTab).setTextureName(RefStrings.MODID + ":pile_rod_thorium");
		pile_rod_thorium_fuel = new ItemPileRod().setUnlocalizedName("pile_rod_thorium_fuel").setCreativeTab(MainRegistry.controlTab).setTextureName(RefStrings.MODID + ":pile_rod_thorium_fuel");
		...
		rbmk_pellet_pameu = (ItemRBMKPellet) new ItemRBMKPellet("Protactinium-230 with MEU Driver Fuel").setUnlocalizedName("rbmk_pellet_pameu").setTextureName(RefStrings.MODID + ":rbmk_pellet_pameu");
		...
		rbmk_pellet_hep242 = (ItemRBMKPellet) new ItemRBMKPellet("Highly Enriched Plutonium-242").setUnlocalizedName("rbmk_pellet_hep242").setTextureName(RefStrings.MODID + ":rbmk_pellet_hep242");
		rbmk_pellet_mepg = (ItemRBMKPellet) new ItemRBMKPellet("Medium Enriched Plutonium-239 with gallium").setUnlocalizedName("rbmk_pellet_mepg").setTextureName(RefStrings.MODID + ":rbmk_pellet_mepg");
		...
		rbmk_pellet_hea243 = (ItemRBMKPellet) new ItemRBMKPellet("Highly Enriched Americium-243").setUnlocalizedName("rbmk_pellet_hea243").setTextureName(RefStrings.MODID + ":rbmk_pellet_hea243");
		...
		rbmk_fuel_hep242 = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_hep242)
				...
				.setUnlocalizedName("rbmk_fuel_hep242")
				.setTextureName(RefStrings.MODID + ":rbmk_fuel_hep242");
		rbmk_fuel_mepg = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_mepg)
				.setYield(10000000D)
				.setStats(40)
				...
				.setTextureName(RefStrings.MODID + ":rbmk_fuel_mepg");
		...
		rbmk_fuel_hea243 = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_hea243)
				...
				.setUnlocalizedName("rbmk_fuel_hea243")
				.setTextureName(RefStrings.MODID + ":rbmk_fuel_hea243");
		...
		rbmk_fuel_pameu = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_pameu)
				.setYield(30000000D)
				.setStats(12.5D)
				.setFunction(EnumBurnFunc.PLATEU)
				.setDepletionFunction(EnumDepleteFunc.BOOSTED_SLOPE)
				.setHeat(0.75D)
				.setMeltingPoint(1841)
				.setTint(0x8C9198).setUnlocalizedName("rbmk_fuel_pameu").setTextureName(RefStrings.MODID + ":rbmk_fuel_pameu");
		...
		ammonium_nitrate = new Item().setUnlocalizedName("ammonium_nitrate").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ammonium_nitrate");
		...
		stick_tatb = new Item().setUnlocalizedName("stick_tatb").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":stick_tatb");
		...
		mixing_vat_template  = new ItemMixingVatTemplate().setUnlocalizedName("mixing_vat_template").setMaxStackSize(1).setCreativeTab(MainRegistry.templateTab).setTextureName(RefStrings.MODID + ":mixing_vat_template");
		mixing_vat_icon = new ItemMixingVatIcon().setUnlocalizedName("mixing_vat_icon").setMaxStackSize(1).setCreativeTab(null);
	...
	public static void initializeItem2() {
		...
		ArmorMaterial aMatEnv = EnumHelper.addArmorMaterial("HBM_ENV", 150, new int[] { 3, 8, 6, 3 }, 0);
		...
		ArmorMaterial aMatTaurun = EnumHelper.addArmorMaterial("HBM_TRENCH", 150, new int[] { 3, 8, 6, 3 }, 0);
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(ingot_u234, ingot_u234.getUnlocalizedName());
		...
		GameRegistry.registerItem(ingot_pu242, ingot_pu242.getUnlocalizedName());
		...
		GameRegistry.registerItem(ingot_am243, ingot_am243.getUnlocalizedName());
		...
		GameRegistry.registerItem(billet_u234, billet_u234.getUnlocalizedName());
		...
		GameRegistry.registerItem(billet_pu242, billet_pu242.getUnlocalizedName());
		...
		GameRegistry.registerItem(billet_am243, billet_am243.getUnlocalizedName());
		...
		GameRegistry.registerItem(billet_pameu, billet_pameu.getUnlocalizedName());
		...
		GameRegistry.registerItem(powder_green_salt, powder_green_salt.getUnlocalizedName());
		...
		GameRegistry.registerItem(nugget_u234, nugget_u234.getUnlocalizedName());
		...
		GameRegistry.registerItem(nugget_pu242, nugget_pu242.getUnlocalizedName());
		...
		GameRegistry.registerItem(nugget_am243, nugget_am243.getUnlocalizedName());
		...
		GameRegistry.registerItem(nugget_pa230, nugget_pa230.getUnlocalizedName());
		...
		GameRegistry.registerItem(stamp_steel_gear, stamp_steel_gear.getUnlocalizedName());
		...
		GameRegistry.registerItem(mixing_vat_icon, mixing_vat_icon.getUnlocalizedName());
		GameRegistry.registerItem(crucible_template, crucible_template.getUnlocalizedName());
		GameRegistry.registerItem(mixing_vat_template, mixing_vat_template.getUnlocalizedName());
		...
		GameRegistry.registerItem(rod_zirnox_u234_depleted, rod_zirnox_u234_depleted.getUnlocalizedName());
		...
		GameRegistry.registerItem(waste_u234, waste_u234.getUnlocalizedName());
		...
		GameRegistry.registerItem(pile_rod_thorium, pile_rod_thorium.getUnlocalizedName());
		GameRegistry.registerItem(pile_rod_thorium_fuel, pile_rod_thorium_fuel.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_fuel_pameu, rbmk_fuel_pameu.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_fuel_hep242, rbmk_fuel_hep242.getUnlocalizedName());
		GameRegistry.registerItem(rbmk_fuel_mepg, rbmk_fuel_mepg.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_fuel_hea243, rbmk_fuel_hea243.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_pellet_pameu, rbmk_pellet_pameu.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_pellet_hep242, rbmk_pellet_hep242.getUnlocalizedName());
		GameRegistry.registerItem(rbmk_pellet_mepg, rbmk_pellet_mepg.getUnlocalizedName());
		...
		GameRegistry.registerItem(rbmk_pellet_hea243, rbmk_pellet_hea243.getUnlocalizedName());
		...
		GameRegistry.registerItem(stick_tatb, stick_tatb.getUnlocalizedName());
		...
		GameRegistry.registerItem(tea_leaf, tea_leaf.getUnlocalizedName());
